...
namespace Portal.MVC.Services
{
    public class WebWorkContext : IWorkContext
    {
        ...
        private readonly UserDbService _userService=new UserDbService();
        ...
        public bool IsAdmin
        {
            get
            {
                return CurrentUser != null ? (CurrentUser.UserRoles.Any(n => n.SystemName == SystemUserRoleNames.Admin)) : _isAdmin;
            }
            set { _isAdmin = value; }
        }
