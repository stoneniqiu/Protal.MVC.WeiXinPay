...
namespace Portal.MVC
{
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ICacheManager>().To<MemoryCacheManager>().WhenInjectedInto<QuestionController>().InSingletonScope();
            kernel.Bind<ICacheManager>().To<MemoryCacheManager>().WhenInjectedInto<MessageService>().InSingletonScope();
           kernel.Bind<ICacheManager>().To<PerRequestCacheManager>().WhenInjectedInto<UserService>().InRequestScope().Named(PortalConfig.PortalCacheRequest);
            ...
            kernel.Bind<IFirendService>().To<FirendService>();
            kernel.Bind<IMessageService>().To<MessageService>();
            kernel.Bind<IPhoneCodeSerice>().To<PhoneCodeSerice>();
