   ...
   public interface IAccountService
    {
       ...
       UserLoginResults ValidateUserByMobile(string mobile, string password);
       ...
       UserRegistrationResult RegisterUser(UserRegistrationRequest request, bool isMobile = false);
