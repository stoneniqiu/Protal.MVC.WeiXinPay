...
namespace Niqiu.Core.Services
{
    public class PortalDb : DbContext, IDbContext
    {
       ...
       // public DbSet<Customer> Customers { get; set; }
        ...
        public PortalDb()
            // : base("Data Source=RJST\\SQL08;Initial Catalog=FileDb;User ID=sa;Password=sa123.;Persist Security Info=True;MultipleActiveResultSets=true")
           : base(CommonHelper.GetConnectString())
        {
