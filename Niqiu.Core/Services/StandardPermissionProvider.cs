...
namespace Niqiu.Core.Services
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //public static readonly PermissionRecord HuJi = new PermissionRecord { Name = "户籍管理", SystemName = "HuJiAdmin", Category = "Users" };
        //public static readonly PermissionRecord Traffic = new PermissionRecord { Name = "治安交通", SystemName = "TrafficAdmin", Category = "Users" };
        //public static readonly PermissionRecord Fire = new PermissionRecord { Name = "消防管理", SystemName = "FireAdmin", Category = "Users" };
